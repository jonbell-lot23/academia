    ...
    <div style={{ marginLeft: "220px" }}>
      ...
      >
        ...
        <p>
          ...
          are uncommon because they're hard to make. So whether reading on a
          website or an ebook, the best technology we have is to put two images
          next to each other and make the user spot the differences.
        </p>
      </div>
    </div>
  );
