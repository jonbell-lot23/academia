...
Now, swing to the other end of the spectrum—transforming each of these functionalities into standalone apps or YouTube explainer videos. No one wants to download a new app for every book they read, or every essay they dive into? Even if these apps came packed with every conceivable feature, the sheer bulk would make them unwieldy, stripping the joy from the act of reading. This is where the elegance of augmented text shines through.
...
(Todo: explain why Tufte is just completely off the reservation here, and why academics are basically impossible reason with because they've decided they're smarter than anyone else, and part of being smart is never changing your mind)
