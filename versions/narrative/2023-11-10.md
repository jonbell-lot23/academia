...
The history of human communication started with speech, evolved to include written history, and in modern times added hyperlinks. Since then, the experience of reading text hasn't seen much improvement. In this paper, I’ll survey the state of multimedia today and explain why augmented text addresses scenarios and needs that are unaddressable with traditional multimedia alone. I’ll round out my work with a pattern library of examples that other researchers can build on.
...
Imagine, for a moment, you're standing in the bustling heart of New York City, craning your neck to capture the full majesty of the Empire State Building. Now, picture yourself turning to a passerby and asking for their thoughts on this marvel of engineering and architecture. Instead of words, they launch into an interpretive dance, limbs flailing in a bizarre pastiche of a 1960s hippie caught in a windstorm. It's humorous, perplexing, and—you have to admit—a little bit impressive. But it doesn't tell you much about the building's art deco design, its place in the skyline, or its cultural significance.

This surreal scenario illustrates a fundamental mismatch between the question asked and the form of communication chosen to answer it. We've all heard the saying, "Writing about music is like dancing about architecture." It's a humorous remark on the absurdity of trying to convey the essence of one art form through the wholly different medium of another. Using the wrong tool for the job can lead to a communication breakdown that, while potentially entertaining, is ultimately uninformative.

In the digital age, this concept takes on new weight. With multimedia, hypertext, and now augmented text at our fingertips, we're tasked with choosing the most effective way to communicate our messages. Should we explain a complex JavaScript function through prose, or would an interactive code block serve better? Can the experience of a live concert be captured in a tweet, or does it demand the richness of a VR simulation? The tools we choose can either enhance our message or muddle it, and finding that sweet spot is both the challenge and the thrill of modern communication.

Let's try an experiment. Click one of the following links to rephrase this section in different ways

- Casual academic format (selected)
...
(Then the section would swap out with "Imagine you're looking up at a really, really tall building and you want to know more about it. You ask someone, and instead of telling you, they start dancing like they're at a fun, silly party. It's funny, but it doesn't really help you learn about the building, does it? A better way to explain the building would be to use words. Or the best way to explain a song would be to sing it. Or the best way to describe a person might be to show a picture. That's what this paper will be talking about!")

### Augmented Text: More than text, less than an app, more powerful than both
...
While interactive media and multimedia have stayed static, games have always been a playground for interactive ideas. But can these gaming elements blend well with traditional communication forms? The answer is both yes and no, which will explore more in the upcoming section.
...
### Principles for Augmented Text

In our journey through the evolution of communication, we've seen a consistent theme: an ongoing quest for more effective ways to share our thoughts and stories. Yet, as we push the boundaries of multimedia, we must be wary not to forsake clarity for complexity. Amidst this, augmented text emerges as a beacon of innovation, promising to transform our interaction with the written word by adhering to the principles of being blended, integrated, and concise.

**Blended:** Augmented text should feel like a natural extension of the narrative, harmonizing with the text rather than jutting out like an awkward appendage. Its interactive elements should weave seamlessly into the fabric of the reading experience.

**Integrated:** The beauty of augmented text lies in its effortless incorporation into the user's journey. It should not hinge on plugins or external tools but exist within the text itself, as intrinsic to the experience as the words on the page.

**Concise:** The essence of augmented text is not to eclipse the written word but to complement it. It should serve to enhance the message with precision and brevity, maintaining the primacy of the text while providing additional layers of meaning and engagement.

As we venture into the realms of games and data visualisation, these three tenets will guide our examination of how they align—or don't—with the ethos of augmented text.
