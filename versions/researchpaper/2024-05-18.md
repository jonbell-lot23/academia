...
This work addresses one question: How can we enhance the reading experience through technology without compromising the essence of traditional reading?

(NP: What is the essence of traditional reading? The analog part? Also, I am a bit confused as analog reading is less augmented than ‘badly’ augmented digital reading.
Either way If this is a key premise of your work you need to make sure you unpack what you mean further down.)

It utilises a methodology that combines qualitative and quantitative approaches in order to quantify the "essence" 

(NP: What is the essence of traditional reading?)

of traditional reading with enhancements that benefit readers of educational and informational content.
<div id="introduction"></div>
## Introduction

(NP: Overall comment: you have some very good stuff here, very engaging reading overall. There are some parts you need to explain a bit more and need to add some refs here and there (see my comments). Also check my comments in your discussion section as I think there is content there that would work better if it was in the the introduction/motivation of your work.)

#### Reading is not natural, and comprehension is hard
(NP: Minor: It would be good to have an introductory sentence here. I know your heading plays the role but my traditional academic writing mind is missing it :D)
...
(NP: Add Connecting/transition sentence here or end of para above to help the narrative.)
...
Between Wolf, Chomsky, and many others,

(NP: Which work specifically, these guys have written lots :D Specify and add refs)
...
(NP: I would prob move these to the discussion but fine here too.)
...
(NP: This belongs to the discussion for me)
...
My research was based on foundational insights from Chomsky, Wolf, Byrne, 

(NP: Chomsky and Byrne have contributed several pieces of research (not just in one area). Be more specific about which specific piece of work or theory of theirs is your work based on.)

and the efforts of the HCI community, particularly Neilson and Raskin. These insights provided a comprehensive academic grounding to understand the ability of the human mind to hear, read, and comprehend information, the principles of successful interface design, and the aids for reading comprehension both in and outside the classroom.

(NP: From your earlier sections/lit review it wasn’t clear that you are focusing on educational/school context and I don’t think you want/should go down that route. I would remove this here. You can do a short discussion at the end of the discussion section and present this as next steps/ how this can be future research i.e. to look into the application of augmented text for educational contexts specifically.)
...
<div id="context"></div>
### Context is king
This work has studied how much we can enhance the reading experience without compromising the essence of traditional reading 

(NP: You mention this quite a bit (see my earlier comment) but for me to make this claim you need to be specific about what you mean by ‘essence’. Otherwise it is just a word and a statement that only has an emotional effect to the reader but no academic substance ;))

which implies that help is always better than no help in this context. It's a statement so obvious as to seem trite, but it will be the foundation we build our entire discussion and further works on, so it's worth stress testing it a bit before we proceed. We need to confirm: is more help always better?
...
(NP: This and paras below are getting closer to unpacking the ‘essence’ etc. but you need to move them upfront to the Motivation Section)
...
(NP: For me this belongs to motivation section ^^ and below too)
...
(NP: This to me fits better/can move to the introduction section ^^ and below)
